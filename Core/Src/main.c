...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
  	/* 1.
  	for(int frequency = 20; frequency < 20000; frequency *= 2){
  			htim1.Instance->ARR = 1000000/frequency -1; //주파수�? 맞는 값�?� 넣�?�
  			htim1.Instance->CCR1 = htim1.Instance->ARR/2; //ARR�?� 절반값�?� 넣�?� (duty 비)
  			HAL_Delay(500);
  	}
  	*/
  	/*
