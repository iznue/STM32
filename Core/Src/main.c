...
/* USER CODE BEGIN Header_FunctionB */
/**
...
void FunctionB(void *argument)
{
  ...
  for(;;)
  {
  	...
  	if(valueAdc[0] > 480 && valueAdc[1] > 550) printf("Fan on\n");
  	*/
    osDelay(1000);
...
/* USER CODE BEGIN Header_FunctionA */
/**
