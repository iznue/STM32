...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
  	...
  	HAL_GPIO_WritePin(LedR_GPIO_Port, LedG_Pin, 1);
  	HAL_GPIO_WritePin(LedR_GPIO_Port, LedB_Pin, 0);
  	HAL_Delay(300);

  	HAL_GPIO_WritePin(LedR_GPIO_Port, LedR_Pin, 0);
  	HAL_GPIO_WritePin(LedR_GPIO_Port, LedG_Pin, 0);
  	HAL_GPIO_WritePin(LedR_GPIO_Port, LedB_Pin, 1);
  	HAL_Delay(300);
  	*/
  	/*
  	...
  	*/
  	...
  	angleG%=360;
  	angleB%=360;
  	int valueR=sin(angleR*3.14/180)*490+499;
  	int valueG=sin(angleR*3.14/180)*490+499;
  	int valueB=sin(angleR*3.14/180)*490+499;
